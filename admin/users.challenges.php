...
<body>
    ...
    <div class="container ch-head" style="text-align: center;">
        <h2>USERS CHALLENGES</h2>
    </div>

    <div class="container" style="padding-top:0px;padding-bottom:0px">        
        <div class="d-thread-search" style="">
        
        <form class="d-flex" style="padding-right: 10px; align-items:center; " action="users.challenges.search.php" method="get"> 
            <center>
    ...
    <div class="challenges container my-4">
        ...
        $sql = "SELECT * FROM `challenges_by_users` ORDER BY `timestamp` DESC ";
