...
<head>
    ...
    <title>FrontendGang | All Challenges</title>
...
<body>
    ...
    <div class="container" style="padding-top:0px;padding-bottom:0px">        
        ...
        <form class="d-flex" style="padding-right: 10px; align-items:center; " action="../challenge_search.php" method="get"> 
            ...
            <div style="display:flex;" >
                ...
                <input style="height: calc(1.5em + .75rem + 2px);box-shadow: 0px 10px 20px -5px rgb(73 93 207 / 20%);" class="thread-search form-control " type="search" name="search" placeholder="Search challange" aria-label="Search">
                </div>
    ...
    <div class="challenges container my-4">
        ...
        <?php
            ...
            $sql = "SELECT * FROM `challenges` ORDER BY `created` DESC ";
                ...
                <div class="col-xs-12 col-sm-6 col-lg-6 my-3">
                    <div class="card" style="padding:0px;box-shadow: 0px 10px 20px -5px rgb(73 93 207 / 20%);">
                        ...
                        <div class="card-body chal-card-body" style="align-item:center; padding: 2.15rem;">
                            ...
                            <div class="row">
                                <div style="padding:0px;margin-right:7px;" class="col">
                                    <div class="container chall-but">
                                    <form action="delete_adminchallenge.php" method="post" style="text-align:center;">
                                        <input type="hidden" value="'.$id.'" name="User_challenge_id" placeholder="'.$id.'" />
                                        <div style="padding-top:0px;"><button type="submit" class="btn btn-primary">Delete</button></div> 
                                    </form>
                                    </div>
                                </div>
                                <div style="padding:0px;" class="col">
                                    <div class="container chall-but">
                                        <a href="../expandchallenge.php?challenge_id='. $id .' " style="background-color:#6c63ff" class="btn btn-primary">View</a>
                                    </div>
                                </div>
                            </div>
                        </div>
