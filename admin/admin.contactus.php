...
<head>
    ...
    <title>FrontendGang | ContactUs</title>
        ...
        <div class="col-xs-12 col-sm-6 col-lg-4 my-3">
                    <div class="card" style="padding:0px;box-shadow: 0px 10px 20px -5px rgb(73 93 207 / 20%);">              
                        <div class="card-body chal-card-body" style="align-item:center; padding: 2.15rem;">
                            ...
                            <h5 class="card-title" style=" line-height: 1.3; font-family: "Archivo", sans-serif;">Email : '.$user_email .'</h5>                    
                            <h5 class="card-title" style=" line-height: 1.3; font-family: "Archivo", sans-serif;">Title : '.$title.' </h5>
                            <div class="container chall-but"><a href="admin.contactus.expand.php?response_id='. $id .' " style="background-color:#6c63ff" class="btn btn-primary">View challenge</a></div>
                        </div>
                    </div>
                </div>';
            }      
