...
<head>
    ...
    <title>FrontendGang | Download Certificate</title>
    <style>
    .d-thread-search{
        padding-left:20px;
        padding-right:10px;
...
<?php  if(isset($_SESSION['loggedin']) && $_SESSION['loggedin']==true){
    $c_id = $_GET['certificate_id'];
    $user_id = $_SESSION['sno'];
     $sql = "SELECT * FROM `certificate` WHERE `id` = $c_id";
    ...
    <div class="container" style="padding-top:0px;padding-bottom:0px">        
        ...
        <?php
                        ...
                        $sql1 = "SELECT * FROM `certficate_status` WHERE `certificate_id`='$c_id' AND `user_id`='$user_id' ";
                        ...
                        while($row = mysqli_fetch_assoc($result1)){
                            ...
                            if(($status==2)&&($u_id ==$user_id)&&($cert_id==$c_id)){  
                                ?>
                                <center>
                                <div><a  class="forum-btn btn-f" href="certificates/<?php echo $id_name;?>.pdf" Download> Download Certificate</a></div>
                                </center>        
                                </div>
                                <?php
                                echo'
    ...
    <center>
    <a href="verify.php"><h4>Click here to Verify Certificate</h4></a>
    </center>
    </div>
    <?php
