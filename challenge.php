...
<head>
    ...
    <title>FrontendGang | Challanges </title>
    <style>
    .d-thread-search{
        padding-left:0px;
        padding-right:10px;
...
<body>
    ...
    <div class="challenges container my-4" style="padding-bottom:100px;">
        ...
        <?php
            ...
            while($row = mysqli_fetch_assoc($result)){
                ...
                echo'
                <div style="margin-bottom:30px;" class="col-xs-12 col-sm-6 col-lg-4 my-3">
